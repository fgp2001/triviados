...
INSERT INTO `preguntas` (`id_incremental`, `pregunta`, `estado`, reportado, `id_usuario`, `id_categoria`) VALUES
(1, '¿Cuál es la capital de Italia?', 1, 0, 3, 1),
(2, '¿Cuál es el río más largo del mundo?', 1, 0, 3, 2),
(3, '¿En qué año comenzó la Segunda Guerra Mundial?', 1, 0, 3, 2),
(4, '¿Qué planeta es el más cercano al sol?', 1, 0, 3, 3),
(5, '¿Quién escribió \'Cien años de soledad\'?', 1, 0, 3, 4),
(6, '¿Cuál es el símbolo químico del oro?', 1, 0, 3, 3),
(7, '¿Quién pintó la Mona Lisa?', 1, 0, 3, 4),
(8, '¿Cuál es el idioma más hablado del mundo?', 1, 0, 3, 1),
(9, '¿Cuántos planetas hay en el sistema solar?', 1, 0, 3, 3),
(10, '¿Qué gas es necesario para que ocurra la combustión?', 1, 0, 3, 3),
(11, '¿Qué instrumento mide la presión atmosférica?', 1, 0, 3, 3),
(12, '¿Quién fue el primer presidente de los Estados Unidos?', 1, 0, 3, 2),
(13, '¿Cuál es el resultado de 9 x 7?', 1, 0, 3, 2),
(14, '¿En qué país se encuentra la Torre Eiffel?', 1, 0, 3, 1),
(15, '¿Qué continente tiene más países?', 1, 0, 3, 1),
(16, '¿Qué animal es conocido como el \"rey de la selva\"?', 1, 0, 3, 4),
(17, '¿Cuál es la capital de Australia?', 1, 0, 3, 1),
(18, '¿Cuántos océanos hay en la Tierra?', 1, 0, 3, 2),
(19, '¿Qué instrumento se usa para ver objetos muy pequeños?', 1, 0, 3, 3),
(20, '¿Qué país tiene forma de bota?', 1, 0, 3, 1),
(21, '¿Cuál es el metal más ligero?', 1, 0, 3, 3),
(22, '¿Qué escritor creó a Sherlock Holmes?', 1, 0, 3, 2),
(23, '¿Cuál es el país con más habitantes?', 1, 0, 3, 1),
(24, '¿Cuál es el órgano más grande del cuerpo humano?', 1, 0, 3, 3),
(25, '¿Qué pintura famosa hizo Vincent Van Gogh?', 1, 0, 3, 4),
(26, '¿Cuál es el elemento más abundante en el aire?', 1, 0, 3, 3),
(27, '¿Qué país inventó el sushi?', 1, 0, 3, 1),
(28, '¿Qué significa la sigla \"ONU\"?', 1, 0, 3, 1),
(29, '¿Qué autor escribió \"El Quijote\"?', 1, 0, 3, 2),
(30, '¿Qué país ganó el Mundial de Fútbol en 2018?', 1, 0, 3, 4);
...
INSERT INTO `usuarios` (`id_incremental`, `email`, `password`, `nombre_completo`, `fecha_nacimiento`, `sexo`, `pais`, `ciudad`, `nombre_usuario`, `foto_perfil`, `validado`, `token_validacion`, `tipo_Usuario`) VALUES
(1, 'admin@admin.com', 'admin123', 'Admin Principal', '1990-01-01', 'otro', 'Argentina', 'Buenos Aires', 'admin', 'admin.jpg', 1, NULL, 'admin'),
(2, 'editor@editor.com', 'editor123', 'Editor Principal', '1990-01-01', 'otro', 'Argentina', 'Buenos Aires', 'editor', 'editor.jpg', 1, NULL, 'editor'),
(3, 'fgp_2001@hotmail.com', 'facu123', 'Facundo Pereira', '2001-01-15', 'masculino', 'Argentina', 'El Palomar', 'Facupe', 'img/Facupe.png', 1, '113ecf408e93b5124ba9e8ddffb921d3', 'Jugador');
